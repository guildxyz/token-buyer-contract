...
import {MockBadERC20} from "src/mock/MockBadERC20.sol";
...
contract TokenBuyerTest is Test {
    ...
    function test_SweepTransferFails() public {
        // recipient address
        uint256 recipientPrivateKey;
        address payable recipient;
        recipientPrivateKey = 0x2EC191E47;
        ...
        // use bad ERC20 contract that doesn't revert
        ...
        vm.prank(feeCollector);
        tokenBuyer.sweep(address(badToken), recipient, 1);
    }
    ...
    function test_SweepOnlyFeeCollector() public {
        ...
        vm.expectRevert(
            abi.encodeWithSelector(IFeeDistributor.AccessDenied.selector, invalidFeeCollector, feeCollector)
        );
